import type { SvelteVirtualListMode } from '../types';
import type { VirtualListSetters, VirtualListState } from './types';
...
export const updateHeightAndScroll = (
	...
	const { initialized, mode, containerElement, viewportElement, calculatedItemHeight, scrollTop } =
		state;
