<script lang="ts">
	...
	import EnhanceScroll from '$lib/components/gear-tooltip2/parts/enhance/EnhanceScroll.svelte';
	import EnhanceScrollSummary from '$lib/components/gear-tooltip2/parts/enhance/EnhanceScrollSummary.svelte';
	import EnhanceStarforce from '$lib/components/gear-tooltip2/parts/enhance/EnhanceStarforce.svelte';
	import Exceptional from '$lib/components/gear-tooltip2/parts/exceptional/Exceptional.svelte';
	import FrameBottom from '$lib/components/gear-tooltip2/parts/frame/FrameBottom.svelte';
	import FrameLine from '$lib/components/gear-tooltip2/parts/frame/FrameLine.svelte';
	import FrameMiddle from '$lib/components/gear-tooltip2/parts/frame/FrameMiddle.svelte';
	import FrameTop from '$lib/components/gear-tooltip2/parts/frame/FrameTop.svelte';
	import Icon from '$lib/components/gear-tooltip2/parts/icon/Icon.svelte';
	import InclineCannot from '$lib/components/gear-tooltip2/parts/incline/InclineCannot.svelte';
	import InclineEquipped from '$lib/components/gear-tooltip2/parts/incline/InclineEquipped.svelte';
	import InclineMinus from '$lib/components/gear-tooltip2/parts/incline/InclineMinus.svelte';
	import InclinePlus from '$lib/components/gear-tooltip2/parts/incline/InclinePlus.svelte';
	import InclineZero from '$lib/components/gear-tooltip2/parts/incline/InclineZero.svelte';
	import PotentialDetail from '$lib/components/gear-tooltip2/parts/potential/PotentialDetail.svelte';
	import PotentialTitle from '$lib/components/gear-tooltip2/parts/potential/PotentialTitle.svelte';
	import ReqLevel from '$lib/components/gear-tooltip2/parts/ReqLevel.svelte';
	import SoulWeapon from '$lib/components/gear-tooltip2/parts/soul/SoulWeapon.svelte';
	import Spacer from '$lib/components/gear-tooltip2/parts/Spacer.svelte';
	import Stars from '$lib/components/gear-tooltip2/parts/star/Stars.svelte';
	import StatLine from '$lib/components/gear-tooltip2/parts/stat/StatLine.svelte';
